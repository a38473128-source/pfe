        ...
        <div className="relative bg-gradient-to-br from-white to-slate-50 rounded-2xl p-8 border border-slate-200 shadow-2xl hover:shadow-blue-200/40 transition-shadow duration-500" style={{
              ...
              <div className="space-y-2 animate-fade-in" style={{ animationDelay: "0.1s" }}>
                ...
                <div className="relative group">
                  <input
                    ...
                    required
                    className="w-full px-3 py-3 bg-white border-2 border-slate-200 rounded-lg text-slate-900 placeholder-slate-400 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/30 transition-all duration-300 hover:border-slate-300 group-hover:border-blue-300"
                  />
                </div>
              </div>
          ...
          <div className="mt-8 pt-8 border-t border-slate-200 text-center animate-fade-in" style={{ animationDelay: "0.4s" }}>
            <p className="text-slate-600 text-sm">
              ...
              <a href="/login" className="text-blue-600 hover:text-blue-700 font-medium transition-all duration-300 hover:underline">
                Sign in
              </a>
            </p>
          </div>
